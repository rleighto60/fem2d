...
This  script  sets  up  FEM2D  for  plane  strain problems for use with the
...
'set sigz=c8*epsx+c6*epsy+c7*gamxy-f1'
...
'set fun'd2c(kind+65)'=epsx,epsy,gamxy,eps1,eps2,gam12,sigx,sigy,sigz,tauxy,sig1,sig2,tau12,sigh,sigd'
exit
